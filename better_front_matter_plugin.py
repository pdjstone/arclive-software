...
def better_front_matter_plugin(md: MarkdownIt, marker_chr: str ='-') -> None:
    """Plugin ported from
    ...
    md.block.ruler.before(
        "table",
        "front_matter",
        partial(_front_matter_rule, marker_chr=marker_chr),
        {"alt": ["paragraph", "reference", "blockquote", "list"]},
    )


def _front_matter_rule(
    state: StateBlock, startLine: int, endLine: int, silent: bool, marker_chr: str
) -> bool:
    min_markers = 3
